...
namespace ZsqAbp.BookStore
{
    ...
    public static class WebContentDirectoryFinder
    {
        public static string CalculateContentRootFolder()
        {
            ...
            while (!DirectoryContains(directoryInfo.FullName, "ZsqAbp.BookStore.sln"))
            {
            ...
            var webFolder = Path.Combine(directoryInfo.FullName, $"src{Path.DirectorySeparatorChar}ZsqAbp.BookStore.Web");
